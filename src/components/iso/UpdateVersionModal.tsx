...
interface UpdateVersionModalProps {
  doc: ISODocument;
  onClose: () => void;
  onUpdate: (file: File, version: string, note: string, contentText?: string) => void;
}
...
export const UpdateVersionModal: React.FC<UpdateVersionModalProps> = ({ doc, onClose, onUpdate }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onUpdate(selectedFile, version, note, contentText);
    } catch (error) {
      ...
      <div className="glass-card w-full max-w-md p-6 space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <button 
            ...
            disabled={isExtracting || !selectedFile || !version}
